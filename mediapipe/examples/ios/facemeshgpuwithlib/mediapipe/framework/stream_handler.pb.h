...
class InputStreamHandlerConfig :
 ...
 public:
  ...
  virtual ~InputStreamHandlerConfig();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_mediapipe_2fframework_2fstream_5fhandler_2eproto);
    return ::descriptor_table_mediapipe_2fframework_2fstream_5fhandler_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  void set_input_stream_handler(const std::string& value);
  void set_input_stream_handler(std::string&& value);
  void set_input_stream_handler(const char* value);
  void set_input_stream_handler(const char* value, size_t size);
 ...
 private:
  ...
  public:
  static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> _i_give_permission_to_break_this_code_default_input_stream_handler_;
  private:
...
class OutputStreamHandlerConfig :
 ...
 public:
  ...
  virtual ~OutputStreamHandlerConfig();
  ...
  void set_output_stream_handler(const std::string& value);
  void set_output_stream_handler(std::string&& value);
  void set_output_stream_handler(const char* value);
  void set_output_stream_handler(const char* value, size_t size);
 ...
 private:
  ...
  public:
  static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> _i_give_permission_to_break_this_code_default_output_stream_handler_;
  private:
...
inline void InputStreamHandlerConfig::clear_input_stream_handler() {
  input_stream_handler_.ClearToDefaultNoArena(&::mediapipe::InputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_input_stream_handler_.get());
...
inline void InputStreamHandlerConfig::set_input_stream_handler(const std::string& value) {
  _internal_set_input_stream_handler(value);
...
inline const std::string& InputStreamHandlerConfig::_internal_input_stream_handler() const {
  return input_stream_handler_.GetNoArena();
}
inline void InputStreamHandlerConfig::_internal_set_input_stream_handler(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  input_stream_handler_.SetNoArena(&::mediapipe::InputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_input_stream_handler_.get(), value);
}
inline void InputStreamHandlerConfig::set_input_stream_handler(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  input_stream_handler_.SetNoArena(
    &::mediapipe::InputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_input_stream_handler_.get(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mediapipe.InputStreamHandlerConfig.input_stream_handler)
}
inline void InputStreamHandlerConfig::set_input_stream_handler(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  input_stream_handler_.SetNoArena(&::mediapipe::InputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_input_stream_handler_.get(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mediapipe.InputStreamHandlerConfig.input_stream_handler)
}
inline void InputStreamHandlerConfig::set_input_stream_handler(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  input_stream_handler_.SetNoArena(&::mediapipe::InputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_input_stream_handler_.get(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mediapipe.InputStreamHandlerConfig.input_stream_handler)
}
inline std::string* InputStreamHandlerConfig::_internal_mutable_input_stream_handler() {
  _has_bits_[0] |= 0x00000001u;
  return input_stream_handler_.MutableNoArena(&::mediapipe::InputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_input_stream_handler_.get());
}
inline std::string* InputStreamHandlerConfig::release_input_stream_handler() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return input_stream_handler_.ReleaseNonDefaultNoArena(&::mediapipe::InputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_input_stream_handler_.get());
}
inline void InputStreamHandlerConfig::set_allocated_input_stream_handler(std::string* input_stream_handler) {
  ...
  input_stream_handler_.SetAllocatedNoArena(&::mediapipe::InputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_input_stream_handler_.get(), input_stream_handler);
...
inline void OutputStreamHandlerConfig::clear_output_stream_handler() {
  output_stream_handler_.ClearToDefaultNoArena(&::mediapipe::OutputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_output_stream_handler_.get());
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void OutputStreamHandlerConfig::set_output_stream_handler(const std::string& value) {
  _internal_set_output_stream_handler(value);
...
inline const std::string& OutputStreamHandlerConfig::_internal_output_stream_handler() const {
  return output_stream_handler_.GetNoArena();
}
inline void OutputStreamHandlerConfig::_internal_set_output_stream_handler(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  output_stream_handler_.SetNoArena(&::mediapipe::OutputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_output_stream_handler_.get(), value);
}
inline void OutputStreamHandlerConfig::set_output_stream_handler(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  output_stream_handler_.SetNoArena(
    &::mediapipe::OutputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_output_stream_handler_.get(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mediapipe.OutputStreamHandlerConfig.output_stream_handler)
}
inline void OutputStreamHandlerConfig::set_output_stream_handler(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  output_stream_handler_.SetNoArena(&::mediapipe::OutputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_output_stream_handler_.get(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mediapipe.OutputStreamHandlerConfig.output_stream_handler)
}
inline void OutputStreamHandlerConfig::set_output_stream_handler(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  output_stream_handler_.SetNoArena(&::mediapipe::OutputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_output_stream_handler_.get(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mediapipe.OutputStreamHandlerConfig.output_stream_handler)
}
inline std::string* OutputStreamHandlerConfig::_internal_mutable_output_stream_handler() {
  _has_bits_[0] |= 0x00000001u;
  return output_stream_handler_.MutableNoArena(&::mediapipe::OutputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_output_stream_handler_.get());
}
inline std::string* OutputStreamHandlerConfig::release_output_stream_handler() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return output_stream_handler_.ReleaseNonDefaultNoArena(&::mediapipe::OutputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_output_stream_handler_.get());
}
inline void OutputStreamHandlerConfig::set_allocated_output_stream_handler(std::string* output_stream_handler) {
  ...
  output_stream_handler_.SetAllocatedNoArena(&::mediapipe::OutputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_output_stream_handler_.get(), output_stream_handler);
