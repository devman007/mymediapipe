...
inline bool ThreadPoolExecutorOptions_ProcessorPerformance_Parse(
    const std::string& name, ThreadPoolExecutorOptions_ProcessorPerformance* value) {
...
class ThreadPoolExecutorOptions :
 ...
 public:
  ...
  virtual ~ThreadPoolExecutorOptions();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_mediapipe_2fframework_2fthread_5fpool_5fexecutor_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  static inline bool ProcessorPerformance_Parse(const std::string& name,
  ...
  void set_thread_name_prefix(const std::string& value);
  void set_thread_name_prefix(std::string&& value);
  void set_thread_name_prefix(const char* value);
  void set_thread_name_prefix(const char* value, size_t size);
...
inline void ThreadPoolExecutorOptions::clear_thread_name_prefix() {
  thread_name_prefix_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void ThreadPoolExecutorOptions::set_thread_name_prefix(const std::string& value) {
  _internal_set_thread_name_prefix(value);
...
inline const std::string& ThreadPoolExecutorOptions::_internal_thread_name_prefix() const {
  return thread_name_prefix_.GetNoArena();
}
inline void ThreadPoolExecutorOptions::_internal_set_thread_name_prefix(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  thread_name_prefix_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ThreadPoolExecutorOptions::set_thread_name_prefix(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  thread_name_prefix_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mediapipe.ThreadPoolExecutorOptions.thread_name_prefix)
}
inline void ThreadPoolExecutorOptions::set_thread_name_prefix(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  thread_name_prefix_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mediapipe.ThreadPoolExecutorOptions.thread_name_prefix)
}
inline void ThreadPoolExecutorOptions::set_thread_name_prefix(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  thread_name_prefix_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mediapipe.ThreadPoolExecutorOptions.thread_name_prefix)
}
inline std::string* ThreadPoolExecutorOptions::_internal_mutable_thread_name_prefix() {
  _has_bits_[0] |= 0x00000001u;
  return thread_name_prefix_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ThreadPoolExecutorOptions::release_thread_name_prefix() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return thread_name_prefix_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ThreadPoolExecutorOptions::set_allocated_thread_name_prefix(std::string* thread_name_prefix) {
  ...
  thread_name_prefix_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), thread_name_prefix);
