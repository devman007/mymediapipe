...
class StatusHandlerConfig :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_mediapipe_2fframework_2fstatus_5fhandler_2eproto);
    return ::descriptor_table_mediapipe_2fframework_2fstatus_5fhandler_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  void set_status_handler(const std::string& value);
  void set_status_handler(std::string&& value);
  void set_status_handler(const char* value);
  void set_status_handler(const char* value, size_t size);
...
inline void StatusHandlerConfig::clear_status_handler() {
  status_handler_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void StatusHandlerConfig::set_status_handler(const std::string& value) {
  _internal_set_status_handler(value);
...
inline const std::string& StatusHandlerConfig::_internal_status_handler() const {
  return status_handler_.GetNoArena();
}
inline void StatusHandlerConfig::_internal_set_status_handler(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  status_handler_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void StatusHandlerConfig::set_status_handler(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  status_handler_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mediapipe.StatusHandlerConfig.status_handler)
}
inline void StatusHandlerConfig::set_status_handler(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  status_handler_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mediapipe.StatusHandlerConfig.status_handler)
}
inline void StatusHandlerConfig::set_status_handler(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  status_handler_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mediapipe.StatusHandlerConfig.status_handler)
}
inline std::string* StatusHandlerConfig::_internal_mutable_status_handler() {
  _has_bits_[0] |= 0x00000001u;
  return status_handler_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* StatusHandlerConfig::release_status_handler() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return status_handler_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void StatusHandlerConfig::set_allocated_status_handler(std::string* status_handler) {
  ...
  status_handler_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), status_handler);
