...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/Cellar/bazel/3.4.1/bin/bazel',
    '/private/var/tmp/_bazel_yuechuanzhen/08d010af22b0c9a0cf823436d071f36d/execroot/mediapipe',
    'ios_x86_64',
    {
        'watchos_armv7k': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/yuechuanzhen/Library/Application Support/Tulsi/0.20200930.88/Bazel',
